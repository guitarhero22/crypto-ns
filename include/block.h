...
public:
    ...
    /**
     * Number of blocks generated by the creator in the longest chain
     * 
     * @param creator ID of the creator
     * @returns Number of blocks generated by the creator in the longest chain
     */
    BID_t blocksInChainById(ID_t creator);
